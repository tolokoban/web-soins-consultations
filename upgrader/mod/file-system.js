...
function cleanPath(path) {
    return __awaiter(this, void 0, void 0, function () {
        var pathesOfFolderToSkip, filesToRemove, foldersToRemove, foldersToVisit, _loop_1, _i, filesToRemove_1, file, _a, foldersToRemove_1, folder;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    pathesOfFolderToSkip = [
                        Path.resolve(path, "data"),
                        Path.resolve(path, update_1["default"].PACKAGE_REL_PATH)
                    ];
                    filesToRemove = [];
                    foldersToRemove = [];
                    foldersToVisit = [path];
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, readDir(currentFolder)];
                                case 1:
                                    dirInfo = _a.sent();
                                    ...
                                    foldersToVisit.push.apply(foldersToVisit, dirInfo.folders
                                        ...
                                        .filter(function (path) { return pathesOfFolderToSkip.indexOf(path) === -1; }));
                                    return [2 /*return*/];
                            }
                        });
                    };
                ...
                case 4:
                    ...
                    console.log("      > " + file);
                    return [4 /*yield*/, deleteFile(file)];
                case 5:
                    _b.sent();
                    _b.label = 6;
                case 6:
                ...
                case 8:
                    ...
                    console.log("      > " + folder);
                    return [4 /*yield*/, deleteFolder(folder)];
                case 9:
                    _b.sent();
                    _b.label = 10;
                case 10:
